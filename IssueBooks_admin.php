...
if (isset($_POST['isbn']) and isset($_POST['username1'])) {
    ...
    if (mysqli_num_rows($result0) > 0)
        echo '<center><B><br>One Copy of this Book is Already Issued on your name!</B></center><br><br>';
    else {
        ...
        if (mysqli_num_rows($result00) == 0)
            echo '<center><B><br>Username does not exist!</B></center><br><br>';
        else {
            ...
            if (mysqli_num_rows($result000) == 0)
                echo '<center><B><br>Invalid ISBN! Please Enter valid ISBN.</B></center><br><br>';
            else {
                $row = mysqli_fetch_array($result000);
                $AvailableCopy = $row['AvailableCopy'];
                $IsReserved = $row['IsReserved'];
                if ($AvailableCopy == 0)
                    echo '<center><B><br>Currently NO copies of this Book are Available, Try Later.</B></center><br><br>';
    ...
    $result0 = mysqli_query($link, $check_qry)  or die(mysqli_error($link));
    if (mysqli_num_rows($result0) == 0)
        echo '<center><B><br>This Book is NOT Issued on your name!</B></center><br><br>';
    else {
